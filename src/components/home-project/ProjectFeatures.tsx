  ...
  return (
    ...
    >
      ...
      <div className="tw--flex tw--flex-col tw--justify-start tw--items-center tw--gap-4">
        ...
        <Typography className="tw--text-[#232323] tw--text-lg tw--text-center">
          Earthquake Resistance
        </Typography>
      </div>
      ...
      <div className="tw--flex tw--flex-col tw--justify-start tw--items-center tw--gap-4">
        ...
        >
          ...
          >
            ...
            >
              <Typography className="tw--font-semibold tw--text-primary tw--text-xl">
                3
              </Typography>
              <Typography className="tw--uppercase tw--font-medium tw--tracking-wider tw--text-[6px] tw--relative">
                years
              </Typography>
            </div>
          </div>
